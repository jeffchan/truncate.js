describe('truncate.js', function () {
  ...
  it('truncates nothing when content fits', function () {
    ...
    assert.equal(this.fixture.clientHeight, 220);
  ...
  describe('when children elements are wrapped', function () {
    it('handles single block element wrap', function () {
      ...
      assert.equal(this.$fixture.html(), "<div>Members, friends, adversari… <a href=\"#\">More</a></div>");
    });
    ...
    it('handles double block element wrap', function () {
      ...
      assert.equal(this.$fixture.html(), "<div><div>Members, friends, adversari… <a href=\"#\">More</a></div></div>");
    });
    ...
    it('handles inline element wrap', function () {
      ...
      assert.equal(this.$fixture.html(), "<span><span>Members, friends, adversari… <a href=\"#\">More</a></span></span>");
    });
    ...
    it('handles single block element with margin wrap', function () {
      ...
      assert.equal(this.$fixture.html(), "<p style=\"margin: 10px; padding: 0;\">Members, friends, advers… <a href=\"#\">More</a></p>");
    });
  });
  ...
  describe('position', function () {
    it('truncate correctly with truncate position at the beginning', function () {
      ...
      assert.equal(this.$fixture.html(), "…g, remaining essentially unchanged.");
    });
